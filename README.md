...
- Tuned prompt to avoid generating unnecessary changes
- Uses the latest version of the README from the HEAD of the branch in live usage
...
When updating the README, consider the following guidelines:
